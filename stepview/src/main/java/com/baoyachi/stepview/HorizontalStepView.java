...
public class HorizontalStepView extends LinearLayout implements HorizontalStepsViewIndicator.OnDrawIndicatorListener
{
    ...
    private int complectedTextColor = ContextCompat.getColor(getContext(), R.color.completed_text_color);//定义默认未完成文字的颜色;
...
//                    }
                    mTextView.setTextColor(complectedTextColor);
//                    Log.i("stepv",i+"----"+mTextView.getText());
